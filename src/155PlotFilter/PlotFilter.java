...
public class PlotFilter {
    ...
    public static void main(String[] args) {
        ...
        //не сразу показывает точки. Без этой команды получится анимация с постепенной отрисовкой точек
        ...
        StdDraw.show(); //только теперь показывает сразу весь рисунок
